...
export default function NotFound() {
  return (
    <div className="flex flex-col gap-4 items-center justify-center min-h-[calc(100vh-64px)]">
      <h1 className="text-2xl font-semibold text-stone-900">Pagina nu a fost găsită</h1>
      <p className="text-sm text-stone-500">
        Pagina pe care ai încercat să o accesezi nu există.
      </p>
      <Link
        className="flex gap-x-1 items-center group text-sm text-brand-600 hover:text-brand-700"
        href="/"
      >
