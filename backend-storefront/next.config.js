...
// R2 CDN si Railway backend
const R2_HOSTNAME = process.env.NEXT_PUBLIC_R2_HOSTNAME || "pub-28d7a4f80d924560ae8c2fe111240e4a.r2.dev"
const RAILWAY_HOSTNAME = process.env.NEXT_PUBLIC_BACKEND_HOSTNAME || "api.ardmag.ro"
...
nextConfig.headers = async () => [
  // Imagini optimizate prin Next.js Image Optimizer
  {
    source: "/_next/image(.*)",
    headers: [{ key: "Cache-Control", value: "public, max-age=31536000, immutable" }],
  },
  // Assets statice (JS, CSS, fonturi, imagini publice)
  {
