...
Surse: WebFetch pe homepage, sitemap, 3 pagini de produs, 2 pagini de categorie, Despre Noi, Terms & Conditions, Shipping & Returns.
...
Aplicată automat la checkout pentru toate produsele din categoria MASTICI TENAX (13 produse marcate cu ribbon "PROMO 30%"). Logica este de tip categorie discount, nu coupon — clientul nu introduce un cod, reducerea se aplică automat. Trebuie recreată în Medusa ca promotion/discount pe categoria MASTICI TENAX.
...
- Divizia DELTA RESEARCH: preluată în 2011, firmă italiană fondată în 1984, produce impermeabilizanți și detergenți pentru piatră naturală
...
Textul complet al paginii este fragmentat și incomplete — necesită rescriere completă pentru noul site.
